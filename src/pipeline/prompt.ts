...
(변형 문항 1-2개 설계 — 선지는 수능 실제 형식, ①②③④⑤ 사용. 문장삽입 유형은 반드시 ①~⑤ 위치 선지 5개 포함 — 선지 없으면 오류. 문장삽입 유형의 삽입 문장은 반드시 새로 창작한다 — 원문에 이미 존재하는 문장 재사용 금지)
...
6. 문장삽입 변형 문항: ①~⑤ 위치 선지 5개 필수 (누락 = 오류). 삽입 문장은 반드시 새로 창작 — 원문 문장 재사용 금지
